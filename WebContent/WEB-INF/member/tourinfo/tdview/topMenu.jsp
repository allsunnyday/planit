          ...
          <div id="nav" class="right">
            <div class="container clearfix">
              <ul id="jetmenu" class="jetmenu blue">
                ...
                <li><a href="#">어디로 갈까</a>
                  <ul class="dropdown">
                    <li><a href="<c:url value='/tourinfo/tdview/TourList.it'/>">관광지 정보</a></li>
                ...
                <li><a href="#">무엇을 먹을까</a>
                  <ul class="dropdown">
                    <li><a href="<c:url value='/tourinfo/tdview/FoodList.it'/>">음식점 정보</a></li>
                ...
                <li><a href="#">어디서 잘까</a>
                  <ul class="dropdown">
                    <li><a href="<c:url value='/tourinfo/tdview/SleepList.it'/>">숙박업소 정보</a></li>
