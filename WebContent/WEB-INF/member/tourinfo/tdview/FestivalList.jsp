...
<!-- ****************************************지역별 버튼 areacode 선택**************************************** -->
         ...
         <form id="justAction" action="<c:url value='/tourinfo/tdview/FestivalList.it?'/> " method="GET" name="searchForm" class="form-inline">
...
<!--             </div> -->
            <div class="form-group" >
               ...
               <a class="dmbutton2 " id="aaa" href="<c:url value='/tourinfo/tdview/FestivalList.it?contenttype=15'/>" >조회순</a>
               <c:if test="${not empty areacode}">
               <a class="dmbutton2" id="bbb" href="<c:url value='/tourinfo/tdview/FestivalList.it?contenttype=15&areacode=${areacode}&orderColumn=title'/>" >제목순</a>
               </c:if>
               <c:if test="${empty areacode }">
               <a class="dmbutton2" id="bbb" href="<c:url value='/tourinfo/tdview/FestivalList.it?contenttype=15&orderColumn=title'/>" >제목순</a>
               </c:if>
            </div>
...
<!-- **********************************관광지 사진과 마우스 올리면 디테일로 넘어가게**************************************** -->   
         <div class="portfolio-centered">
            ...
            <c:forEach var="record" items="${festival}" >
...
<div class="row">
   <div class="text-center">
      ...
      <form class="form-inline" method="post"
         action="<c:url value='/tourinfo/tdview/FestivalList.it?contenttype=15&searchColumn=title&searchColumn=tel'/>">
