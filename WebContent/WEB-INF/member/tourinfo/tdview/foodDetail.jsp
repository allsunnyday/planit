      ...
      <div class=" col-lg-12 col-md-12 col-sm-12 clearfix">
        ...
        <nav class="portfolio-filter clearfix">
          <ul>
            ...
            <li><a href="#" class="dmbutton2" data-filter=".hotel">한식</a></li>
            <li><a href="#" class="dmbutton2" data-filter=".motel">중식</a></li>
            <li><a href="#" class="dmbutton2" data-filter=".pension">양식</a></li>
            <li><a href="#" class="dmbutton2" data-filter=".pension">일식</a></li>
          </ul>
        </nav>
