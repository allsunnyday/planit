    ...
    <div class="container clearfix">
      <div class=" col-lg-12 col-md-12 col-sm-12 clearfix">
        ...
        <nav class="portfolio-filter clearfix">
          <ul>
            <li><a href="#" class="dmbutton2" data-filter="*">All Review (6)</a></li>
            <li><a href="#" class="dmbutton2" data-filter=".mockups">Best</a></li>
            <li><a href="#" class="dmbutton2" data-filter=".graphic-design">Recent</a></li>
            <li><a href="#" class="dmbutton2" data-filter=".web-design">Mix</a></li>
          </ul>
        </nav>
