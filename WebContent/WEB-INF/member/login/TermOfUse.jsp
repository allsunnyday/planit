...
제 1 장 총 칙
제1조 목적
이 약관은  플랜잇(www.planit.co.kr, www.planitplanner.com, www.planittour.com) 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 현행 법령에 위반하지 않는 범위 내에서 회원의 기본적인 권리와 책임 및 당사와의 중요사항을 정하는 것을 목적으로 합니다.
...
- '게시물'이라 함은 '회원'이 '서비스'를 이용함에 있어 게시한 부호,문자,화상 등의 정보형태의 글,사진,동영상 및 각종 화일과 링크 등을 말합니다.
...
제15조 회원의 게시물
(1) '게시물'이라 함은 '서비스'내에 '회원'이 올린 글, 사진, 그림,상품리뷰 등의 정보를 의미합니다.
...
주식회사 스투비플래너("회사" 또는 "플랜잇"라 함)는 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 개인정보보호법, 통신비밀보호법, 전기통신사업법, 등 정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보취급방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다. 
본 개인정보취급방침은 회사가 제공하는 스투비 및 스투비 관련 제반 서비스 (모바일 웹/앱 포함) 이용에 적용되며 다음과 같은 내용을 담고 있습니다.


개요
(주)플랜잇(이하 ‘회사'라 함)는 정보이용자(이하 ‘이용자'라 함)가 회사에서 제공하는 웹서비스, 모바일 어플리케이션 등 제반 서비스를 이용함에 있어, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 및 개인정보 보호법에 따라 이용자의 개인정보를 보호하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같은 처리방침을 두고 있습니다.
...
- 개인정보를 제공받는 자 : 항공/숙박/여행 상품 제공 업체
...
성 명 : 김잇잇
직 책 : (주)플랜잇 대표
이메일 : plant:it_team@gmail.com
주 소 : 서울 금천구 디지털로 123 311호, (주)플랜잇
