...
$(function() {
    ...
    $("#idcheck").click(function() {    	
        ...
        $.ajax({
            ...
            type : 'POST',
            data : id,
            url : "<c:url value='/planit/member/idcheck.it'/>",
            dataType : "text",
            ...
            success : function(data) {
                ...
                if (data > 0) {                    
                	...
                	console.log(data);
                    if(!isidcheck) alert("사용가능한 아이디입니다.");
                    $("#pwd").focus();
                    isidcheck = true;
		...
		<div class="row">
			<div
				...
				<form role="form" id="userjoinform" action="<c:url value='/member/login/UserJoinFormProcess.it'></c:url>" method="post" class="f1">
					<div>
					<h3>Plan:It</h3>
					<p style="display:inline-block">회원가입을 통해 더 많은 여행 계획을 즐겨보세요  </p>
					<button style="position:absolute; right: 35px;"type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target=".bs-example-modal-lg">이용약관</button>
		
					<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
						  <div class="modal-dialog modal-lg">
						    <div class="modal-content">
						    <div class="modal-body">
						     <%-- 	<jsp:include page="<c:url value='/member/login/TermOfUse.txt'></c:url>"></jsp:include> --%>
						     	 <%-- <jsp:include page=""></jsp:include>  --%>
						     	<%-- <%@include file="member/login/TermOfUse.txt" %> --%>
					...
					<fieldset>
						...
						<div class="form-group">
							<label class="sr-only" for="f1-repeat-password">Repeat
								password</label> <input type="password" name="repeatpassword"
								placeholder="Repeat password..."
								class="f1-repeat-password form-control" id="repeatpassword">
						</div>
						<div class="f1-buttons">
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<!-- <input type="text" name="gender" placeholder="Gender...(Please enter M or F)"
								class="f1-twitter form-control" id="gender"> -->
							<select id="gender" name="gender" class="f1-twitter form-control">
						...
						<div class="form-group">
			                  <div class="checkbox">
			                     <input name="userTermCheck" type="checkbox"><span>이용약관 동의(필수)</span>
			                  </div>
			               </div>
						<div class="f1-buttons">
							<button type="button" class="btn btn-previous">Previous</button>
